...
const NavDrawer: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  ...
  return (
    <div ref={drawerRef} className="fixed top-0 left-0 bottom-0 w-72 bg-white z-30">
        <nav className="fixed block top-0 bottom-0 w-[285px] h-[calc(100vh-49px)] text-white transition-opacity duration-300 ease-0 left-0 drawer-enter-done">
